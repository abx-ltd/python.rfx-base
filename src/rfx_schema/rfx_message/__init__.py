...
class RFXMessageConnector(SqlaDriver):
    __db_dsn__ = schema_config.RFX_MESSAGE_DB_DSN
    __schema__ = schema_config.RFX_MESSAGE_SCHEMA


class Base(RFXMessageConnector.__data_schema_base__, DomainSchema):
    __abstract__ = True
    __table_args__ = {"schema": schema_config.RFX_MESSAGE_SCHEMA}
...
SCHEMA = schema_config.RFX_MESSAGE_SCHEMA
