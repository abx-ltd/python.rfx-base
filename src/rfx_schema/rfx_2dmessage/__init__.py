...
class RFX2DMessageConnector(SqlaDriver):
    __db_dsn__ = schema_config.RFX_2DMESSAGE_DB_DSN
    __schema__ = config.RFX_2DMESSAGE_SCHEMA


class Base(RFX2DMessageConnector.__data_schema_base__, DomainSchema):
    __abstract__ = True
    __table_args__ = {"schema": config.RFX_2DMESSAGE_SCHEMA}
