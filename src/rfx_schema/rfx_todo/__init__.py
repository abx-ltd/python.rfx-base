...
class RFXTodoConnector(SqlaDriver):
    __db_dsn__ = schema_config.RFX_TODO_DB_DSN
    __schema__ = schema_config.RFX_TODO_SCHEMA


class Base(RFXTodoConnector.__data_schema_base__, DomainSchema):
    __abstract__ = True
    __table_args__ = {"schema": schema_config.RFX_TODO_SCHEMA}
...
SCHEMA = schema_config.RFX_TODO_SCHEMA
