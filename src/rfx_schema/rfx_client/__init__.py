...
class RFXClientConnector(SqlaDriver):
    __db_dsn__ = schema_config.RFX_CLIENT_DB_DSN
    __schema__ = schema_config.RFX_CLIENT_SCHEMA


class Base(RFXClientConnector.__data_schema_base__, DomainSchema):
    __abstract__ = True
    __table_args__ = {"schema": schema_config.RFX_CLIENT_SCHEMA}
...
SCHEMA = schema_config.RFX_CLIENT_SCHEMA
