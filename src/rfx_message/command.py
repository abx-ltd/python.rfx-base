...
def notify_recipients(client, recipients: list, kind: str, target: str, msg: dict, batch_id=None):
    ...
    for user_id in recipients:
        ...
        channel = client.notify(user_id=user_id, kind=kind, target=target, msg=msg, batch_id=batch_id)
    ...
    async def _process(self, agg, stm, payload):
        try:
            ...
            if processing_mode == ProcessingMode.SYNC:
                ...
                channels = notify_recipients(client, recipients, "message", message_id, message, batch_id="sync_batch")
                ...
                channels = notify_recipients(client, recipients, "message", message_id, message, batch_id="immediate_batch")
                ...
                channels = notify_recipients(client, recipients, "message", message_id, message, batch_id="async_batch")
